...
- **[Chapter #1: Speaking Mathematically](chapter-01-speaking-mathematically)** (1.4 The Language of Graphs not covered)
  - [1.1: Variables](chapter-01-speaking-mathematically/1-1-variables/)
  - [1.2: The Language of Sets](chapter-01-speaking-mathematically/1-2-the-language-of-sets/)
...
Any referenced concepts are presented for educational purposes only. No substantial portions of the original text are reproduced, and any quoted material remains the property of its respective copyright holder and is included under fair use.

- I'm required to include this stub here, I'm not allowed to include any diagrams without completely remaking them so it'll be largely lacking of diagrams (sadly).
